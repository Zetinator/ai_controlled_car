...
class CarController:
    def __init__(self):
        ...
        rospy.topics.Subscriber("/manual_control/Joy", Joy, self.read_joystick)
    ...
    #     # manual brake
    #     if (self.joystick_state.buttons[0] != 0):
    #         self.stop()
    #     # acceleration
    #     if (self.joystick_state.axes[5] < 1):
    #         self.pubSpeed(self.joystick_state.axes[5]-1)/2 * (280)
    #     # reverse
    #     if (self.joystick_state.buttons[4] and self.joystick_state.axes[2] < 1):
    #         self.pubSpeed(self.joystick_state.axes[5]-1)/2 * (-280)
    #     # steering
    #     self.pubSteering(self.joystick_state.axes[0]*(90) + 90)
